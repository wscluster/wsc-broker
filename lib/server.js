 ...
 * @param   {Object}   [options.httpServer]        The Node http or https server instance to attach to.
 * @param   {Boolean}  [options.autoAccept = true] If true, the server will accept sessions automatically.
 */
